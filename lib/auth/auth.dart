...
class AuthClass with ChangeNotifier {
  ...
  Future<Map> createAccount(Police police, String email, String password) async {
    Map authStatus = {
      'status': false,
    ...
    try {
      ...
      police.email = result.user!.email!;
      police.tid = result.user!.uid;
  ...
  //Sign in user
  Future<Map> signIN(Police police, String email, String password) async {
    Map authStatus = {
      'status': false,
